...
@click.option(
    ...
    "OPENROUTER_API_KEY, MOONSHOT_API_KEY); only needed on a cache miss.",
)
@click.option(
    "--model",
    default=None,
...
@click.option(
    ...
    '"fireworks", "perplexity", "openrouter", "moonshot"). Naming uses its own '
    "separate --naming-provider, not this one.",
)
