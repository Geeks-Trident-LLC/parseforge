...
@click.option(
    ...
    "XAI_API_KEY, TOGETHER_API_KEY, FIREWORKS_API_KEY, PERPLEXITY_API_KEY); only "
    "needed on a cache miss.",
)
@click.option(
    "--model",
    default=None,
...
@click.option(
    ...
    '"fireworks", "perplexity"). Naming uses its own separate --naming-provider, '
    "not this one.",
)
