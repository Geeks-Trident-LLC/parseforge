"""Live integration test for generation.generate() via textfsm-ai + Moonshot.
...
def test_generate_show_clock(moonshot_key: str) -> None:
    result = generate(SAMPLE, "moonshot", moonshot_key, MODEL)
