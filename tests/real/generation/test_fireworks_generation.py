"""Live integration test for generation.generate() via textfsm-ai + Fireworks.
...
def test_generate_show_clock(fireworks_key: str) -> None:
    result = generate(SAMPLE, "fireworks", fireworks_key, MODEL)
