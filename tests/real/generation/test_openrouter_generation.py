"""Live integration test for generation.generate() via textfsm-ai + OpenRouter.
...
def test_generate_show_clock(openrouter_key: str) -> None:
    result = generate(SAMPLE, "openrouter", openrouter_key, MODEL)
