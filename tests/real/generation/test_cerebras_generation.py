"""Live integration test for generation.generate() via textfsm-ai + Cerebras.
...
def test_generate_show_clock(cerebras_key: str) -> None:
    result = generate(SAMPLE, "cerebras", cerebras_key, MODEL)
