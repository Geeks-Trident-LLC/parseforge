"""Live integration test for generation.generate() via textfsm-ai + Groq.
...
def test_generate_show_clock(groq_key: str) -> None:
    result = generate(SAMPLE, "groq", groq_key, MODEL)
