"""Live integration test for generation.generate() via textfsm-ai + Mistral.
...
def test_generate_show_clock(mistral_key: str) -> None:
    result = generate(SAMPLE, "mistral", mistral_key, MODEL)
