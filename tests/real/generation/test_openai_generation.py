"""Live integration test for generation.generate() via textfsm-ai + OpenAI.
...
def test_generate_show_clock(openai_key: str) -> None:
    result = generate(SAMPLE, "openai", openai_key, MODEL)
