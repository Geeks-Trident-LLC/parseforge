"""Live integration test for generation.generate() via textfsm-ai + Perplexity.
...
def test_generate_show_clock(perplexity_key: str) -> None:
    result = generate(SAMPLE, "perplexity", perplexity_key, MODEL)
