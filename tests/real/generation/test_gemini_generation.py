"""Live integration test for generation.generate() via textfsm-ai + Gemini.
...
def test_generate_show_clock(gemini_key: str) -> None:
    result = generate(SAMPLE, "gemini", gemini_key, MODEL)
