"""Live integration test for generation.generate() via textfsm-ai + Cohere.
...
def test_generate_show_clock(cohere_key: str) -> None:
    result = generate(SAMPLE, "cohere", cohere_key, MODEL)
