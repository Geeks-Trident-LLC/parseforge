"""Live end-to-end trial pipeline test: real Cisco sandbox + DeepSeek
...
real SSH connection and makes real DeepSeek API calls (costs tokens).
"""
...
from parseforge.naming import CliContext, DeepSeekRegexBuilder
